...
const routes = [{
        ...
        children: [
            {
                path: ':id',
                loadChildren: () => __webpack_require__.e(/*! import() | modules-news-by-id-news-by-id-module */ "modules-news-by-id-news-by-id-module").then(__webpack_require__.bind(null, /*! ./modules/news-by-id/news-by-id.module */ "./src/app/modules/news/modules/news-by-id/news-by-id.module.ts")).then(m => m.NewsByIdModule)
            }
        ]
    }];
...
NewsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NewsComponent, selectors: [["app-news"]], decls: 6, vars: 0, consts: [[1, "source-container"], [1, "source-title"], [1, "article-info-container"], [1, "article-info"]], template: function NewsComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _news_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./news-routing.module */ "./src/app/modules/news/news-routing.module.ts");
